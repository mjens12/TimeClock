...
/**
 * The Money class handles all actions and calculations
 * regarding currency earned during the work week.
 * 
 * This class also contains methods to convert one currency
 * to another. 
 * 
...
public class Money {
	...
	/** Variable that determines if overtime
...
//	private double payRate = 0.0;
	 ...
	 * Method is called when OT is enabled and 
	 * the total hours is above 40.0.
	...
	/**
	 * Getter method that returns the current
	 * state of overtime.
	 * 
