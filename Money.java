...
public class Money {
	...
	public double calcGrossEarnings(final double time,
		...
		switch(currency) {
			case 1: // EURO
				grossPay= grossPay * .90;
				break;
			case 2: // YEN
				grossPay= grossPay * 106.81;
				break;
			case 3: //POUND
				grossPay= grossPay * .82;
				break;
			case 4: // AUD
				grossPay= grossPay * 1.47;
				break;
			case 5: // CAD
				grossPay= grossPay * 1.32;
				break;
			case 6: // PESO
				grossPay= grossPay * 19.27;
			default:
				break;
		}
